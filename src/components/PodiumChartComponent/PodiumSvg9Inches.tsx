...
const PODIUM_COLORS = {
  first:  { bar: '#FFD700', top: 'rgba(255,215,0,0.6)', badge: '#FFD700' },
  second: { bar: '#A0A0B0', top: 'rgba(160,160,176,0.6)', badge: '#C0C0C0' },
  third:  { bar: '#CD7F32', top: 'rgba(205,127,50,0.6)', badge: '#CD7F32' },
};
