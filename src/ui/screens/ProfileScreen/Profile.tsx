...
import { useUser } from '@domain/context/UserContext'; // Importa el hook useAuth

//Services


import StadisticsScreen from './Stadistics';
import _404Page from '@ui/screens/404Screen/404';
import Badges from './Badges';
import EllipseComponent from '@ui/components/ElipseComponent/ElipseComponent';
import Spacer from '@ui/components/SpacerComponent/Spacer';
...
const ProfileScreen = ({ navigation }) => {
  ...
  const { profilePicture, userPoints, user } = useUser();
  ...
  return (
    <ScrollView style={ProfileStyles.containerMax} contentContainerStyle={ProfileStyles.container}>
      ...
      <View style={ProfileStyles.containerDashboard}>
        <Text style={ProfileStyles.TextProfile}>{user.personal_info.name.names || 'Usuario'}</Text>
