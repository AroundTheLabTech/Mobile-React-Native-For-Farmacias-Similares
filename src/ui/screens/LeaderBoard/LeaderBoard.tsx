...
import LeaderBoardCard from '@ui/components/LeaderBoardCardComponents/LeaderBoardCard';
import DraggableMenu from '@ui/components/DraggableMenuComponent/DraggableMenu';
import PodiumSvg from '@ui/components/PodiumChartComponent/PodiumSvg';
import { getTopTwenty } from '@application/services/backend';
import { TLeaderBoard } from 'src/shared/types/user';
import { calculatePercent, splitTopTwenty } from '@shared/utils/helpers';
